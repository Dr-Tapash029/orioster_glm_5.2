  ...
  return (
    <div className="space-y-4">
      <SectionHeader
        ...
        action={
          canAddPatient && (
            <Button onClick={() => setView('patient-entry')} className="gap-2">
              ...
              <tbody>
                {patients.map((p) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0">
                          <p className="truncate font-medium leading-tight">{p.fullName}</p>
                    ...
                    <td className="hidden max-w-[200px] truncate px-3 py-3 text-muted-foreground md:table-cell">
                      {p.chiefComplaint ?? '—'}
                    </td>
